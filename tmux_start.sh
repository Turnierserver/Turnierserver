...
tmux new-window -t turnierserver:6 -n 'Sandbox 3' './build/sandbox.sh ../SandboxManager/sandbox.prop; read'
tmux new-window -t turnierserver:7 -n 'Sandbox 4' './build/sandbox.sh ../SandboxManager/sandbox.prop; read'
tmux new-window -t turnierserver:8 -n 'Frontend' 'cd Frontend; python3 app.py run; read'
# für gunicorn:
#tmux new-window -t turnierserver:8 -n 'Frontend' 'cd Frontend; gunicorn -b 0.0.0.0:80 app:app --log-level INFO; read'
