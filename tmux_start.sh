...
tmux new-window -t turnierserver:4 -n 'Sandbox 1' './build/sandbox.sh Sandbox/SandboxMachine.ini; read'
tmux new-window -t turnierserver:5 -n 'Sandbox 2' './build/sandbox.sh Sandbox/SandboxMachine.ini; read'
