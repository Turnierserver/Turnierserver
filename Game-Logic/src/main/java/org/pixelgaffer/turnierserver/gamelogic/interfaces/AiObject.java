...
public class AiObject {
    ...
    /**
     * Der score der AI, der am Ende in die Datenbank gespeichert wird (z.B. +1
     * für den Sieger, -1 für den Verlierer)
     */
    public int score = 0;
    ...
    /**
     * Das letzte mal als startCalculationTimer oder updateCalculationTimer
     * aufgerufen wurde
     */
     ...
     * 
     * @param Die
     *            Intervalle, in welchen die Rechenpunkte geupdated werden
     *            sollen (<= 0, wenn sie nicht automatisch geupdated werden
     *            sollen)
     */
