...
public abstract class GameLogic<E extends AiObject, R> {
    ...
    /**
     * Der Fortschritt, welcher angezeigt werden soll, -1, wenn keiner angezeigt
     * werden soll
     */
	...
	// logger.info("Eine Nachricht wurde von einer AI(" + ai.getIndex() + ")
	// empfangen: " + new String(message, StandardCharsets.UTF_8));
    ...
    /**
     * Gibt zurück, ob die Anzahl an gespielten Runden der Anzahl an zu
     * spielenden Runden ist
     * 
